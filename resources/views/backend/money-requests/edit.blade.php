                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="time" name="today_open_time" value="{{ $data->today_open_time }}" id="today_open_time" class="form-control">
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="time" name="today_close_time" value="{{ $data->today_close_time }}" id="today_close_time" class="form-control">
                                        </div>
                                    </div>
