                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="row">
                                    ...
                                    <form action="{{ route('admin.gamenames.store') }}" method="POST">
                                        @csrf
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control" name="name_hindi" id="name_hindi" placeholder="name_hindi" />
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="time" name="today_close_time" id="today_close_time" class="form-control">
                                        </div>
                                    </div>
