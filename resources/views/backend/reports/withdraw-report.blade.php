                                                    ...
                                                    <table class="table table-striped table-bordered datatable_data">
                                                        ...
                                                        <tbody id="getBidHistory">
                                                            @foreach($data as $item)
                                                                <tr>
                                                                    <th>{{ isset($item->user->name) ? $item->user->name :'' }}</th>
                                                                    <th>{{ isset($item->user->mobile) ? $item->user->mobile :'' }}</th>
                                                                    <th>{{ isset($item->amount) ? $item->amount :'' }}</th>
                                                                    <th>{{ isset($item->payment_method) ? $item->payment_method :'' }}</th>
                                                                    <th>{{ isset($item->id) ? $item->id :'' }}</th>
