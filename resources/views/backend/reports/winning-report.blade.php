                                            ...
                                            <div class="col-sm-12 col-12 ">
                                                <div class="card">
                                                    <div class="card-body">
                                                        ...
                                                        <form name="gameSrchFrm" method="get" action="{{route('admin.winning_report')}}">
                                                            <div class="row">
                                                                ...
                                                                <div class="form-group col-md-3">
                                                                    ...
                                                                    <select id="bid_type" name="bid_type" class="form-control">
                                                                        ...
                                                                        <option value="triple-panna" @if($request->bid_type == "triple-panna") selected="selected" @endif>Triple Pana</option>
                                                                        <option value="hald-sangam" @if($request->bid_type == "half-sangam") selected="selected" @endif>Half Sangam</option>
