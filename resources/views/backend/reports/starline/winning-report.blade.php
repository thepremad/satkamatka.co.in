                                    ...
                                    <div class="col-12 col-sm-12 col-lg-12">
                                        <div class="row">
                                            <div class="col-sm-12 col-12 ">
                                                <div class="card">
                                                    <div class="card-body">
                                                        <h4 class="card-title">Winning Report</h4>
                                                        <form name="gameSrchFrm" method="get" action="{{route('admin.starline.winning_report')}}">
                                                            <div class="row">
                                                        ...
                                                        <tbody id="getBidHistory">
                                                            @foreach($bidHistory as $bid)
                                                                <tr>
                                                                    ...
                                                                    <td> {{ $bid->session }}</td>
                                                                    <td>
                                                                    @if(($bid->bid_type == 'single-panna' || $bid->bid_type == 'double-panna'|| $bid->bid_type == 'triple-panna') && $bid->session == 'open')
                                                                    {{ $bid->game_number }}
                                                                    @else
                                                                    {{ sumValue($bid->game_number) }}
                                                                    @endif
                                                                    </td>
                                                                    <td> 
                                                                    @if($bid->bid_type == 'jodi-digit')
                                                                        {{ getLeftRightValue($bid->game_number, 'left') }}
                                                                    @elseif($bid->session == 'open')
                                                                        {{ $bid->game_number }}
                                                                    @else
                                                                    N/A
                                                                    @endif
                                                                    ...
                                                                    <td>
                                                                    @if(($bid->bid_type == 'single-panna' || $bid->bid_type == 'double-panna'|| $bid->bid_type == 'triple-panna') && $bid->session == 'close')
                                                                    {{ $bid->game_number }}
                                                                    @else
                                                                    N/A
                                                                    @endif
                                                                    ...
                                                                    <td> 
                                                                    @if($bid->bid_type == 'jodi-digit')
                                                                        {{ getLeftRightValue($bid->game_number, 'right') }}
                                                                    @elseif($bid->session == 'close')
                                                                    {{ sumValue($bid->game_number) }}
                                                                    @else
                                                                        N/A
                                                                    @endif
