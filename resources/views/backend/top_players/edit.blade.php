                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="text" class="form-control" required name="name" id="name" placeholder="Name" value="{{ $player->name }}" />
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="number" class="form-control" required name="amount" id="name_hindi" placeholder="Name in hindi" value="{{$player->amount }}" />
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            <label for="today_open_time">Digit</label>
                                            <input type="text" name="digit" required id="today_open_time" class="form-control" placeholder="Enter Digit" value="{{$player->digit }}">
                                        </div>
                                    </div>
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <select class="form-select" name="game_id" id="basicSelect" required>
                                                ...
                                                @foreach ($game as $item)
                                                    <option value="{{ $item->id }}" {{ ($player->game_id == $item->id ? "selected":"") }}  >{{ $item->name }} ( {{ $item->today_open_time }} : {{ $item->today_close_time }} )</option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-xl-4 col-md-6 col-12">
                                        <div class="mb-1">
                                            ...
                                            <input type="datetime-local" name="time" required id="today_open_time" class="form-control" value="{{$player->time }}">
                                        </div>
                                    </div>
