...
<div class="app-content content ">
    ...
    <div class="content-wrapper container-xxl p-0">
                                            ...
                                            <div class="col-sm-12 col-12 ">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body">
                                                        ...
                                                        <form name="gameSrchFrm" id="gameSrchFrm" >
                                            ...
                                            <div class="col-sm-12 col-12 ">
                                                ...
                                                <div class="card">
                                                    ...
                                                    <div class="card-body" id="desclare_result" style="display: none;">
                                                        <form action="{{ route('admin.declare_result_save') }}" method="POST">
                                                                ...
                                                                <div class="col-12 col-md-12">
                                                                    <div class="row">
                                                                        ...
                                                                        <div class="form-group col-md-4">
                                                                            ...
                                                                            <label>Panna:</label>
                                                                            <select
                                                                                class="form-control select2 getDigitCloseResult "
                                                                                name="close_number" id="close_number"
                                                                                data-placeholder="Select panna"
                                                                                data-select2-id="close_number"
                                                                                tabindex="-1" aria-hidden="true">
                                                                        ...
                                                                        <div class="form-group col-md-4">
                                                                            <label>Digit</label>
                                                                            <input class="form-control" type="number"
                                                                                name="close_result" id="close_result"
                                                                                disabled>
                                                                        </div>
                                                                        ...
                                                                        <div class="form-group col-md-4"
                                                                            ...
                                                                            <button type="button"
                                                                                ...
                                                                                onclick="closeSaveData();"
                                                                                readonly="">Save</button>

                                                                            <button type="button"
                                                                                class="btn btn-primary waves-light mr-1 display_none"
                                                                                id="closeDecBtn" name="closeDecBtn"
                                                                                onclick="decleareCloseResult();">Declare</button>
       ...
       name="result_date_filter" id="result_pik_date"
       value="{{ isset($_GET['result_date_filter']) ? $_GET['result_date_filter'] : '' }}" max="{{ date('Y-m-d') }}">
                                                            ...
                                                            <div class="col-md-5">
                                                                    ...
                                                                    <a class="btn btn-dark" href="{{ url('admin/declare-result') }}">Reset</a>
                                                                </div>
                                                                <div class="col-md-2">
                                                                    <!--<button type="submit" class="btn btn-primary">Submit</button>-->
                                                    ...
                                                    <table class="table table-striped table-bordered datatable_data">
                                                        ...
                                                        <tbody id="getGameResultHistory">
                                                            ...
                                                            <tr>
                                                                <td>{{ $i }}</td>
                                                                <td>{{ $val->name }}</td>
                                                                <td>{{ isset($_GET['result_date_filter']) ? $_GET['result_date_filter'] : date('Y-m-d') }}</td>
                                                                <td>{{ $val->today_open_time }}</td>
                                                                <td>{{ $val->today_close_time }}</td>
                                                                <td>{{ $val->open_result }}
                                                                    @if($val->open_result != '***-*')
                                                                    <br>
                                                                ...
                                                                <td>{{ $val->close_result }}
                                                                    @if($val->close_result != '***-*')
                                                                    <br>
                                                                        <a href="#" onClick="redirect({{ $val->close_id }})"><button class="btn-danger" >Delete</button></a>
                                                                    @endif
                                                                </td>
        ...
        <script>
             function redirect(id) {
                ...
                if (confirmed) {
                    window.location.href = "{{ route('admin.delete-declare-result', '') }}" + '/' + id;
                } else {
        ...
        <script>
            ...
            function showclose(close) {
                ...
                $(document).on('change','#result_dec_date',function(e){
                    ...
                    // formData('result_dec_date',result_dec_date);
                    formData.append('result_dec_date', result_dec_date);
                    $.ajax({
                        type: 'GET',
                        // dataType: "json",
                        url: "{{ route('admin.result.get_game_name') }}",
                        data: formData,
                        processData: false,
                        contentType: false,
                        headers: {
                        ...
                        success: function(data) {
                            if ($.isEmptyObject(data.error)) {
                                ...
                                $.each(data.data, function (key, value) {
                                    //$("#game_id").append('<option value="' + value
                                      //  .id + '">' + value.name + '(' + value.today_open_time + '-' + value->today_close_time + ')</option>');
                                      $("#game_id").append('<option value="' + value.id + '">' + value.name + '(' + value.today_open_time + '-' + value/* */.today_close_time + ')</option>');
                ...
                $(document).on('click','#srchBtn',function(e){
                    ...
                    $.ajax({
                        type: 'POST',
                        // dataType: "json",
                        url: "{{ route('admin.check_is_declare_or_not') }}",
                        data: formData2,
                        processData: false,
                        contentType: false,
                        headers: {
                        ...
                        success: function(data) {
                            if (data == 0) {
                               $('#desclare_result').show()
                                ...
                                $('#desclare_result').hide()
                                toastr.options.timeOut = 10000;
                                toastr.error('Already Result Declared');
                            }
                        }
                    });
                ...
                $(document).on('click','#openSaveBtn',function(e){
                   ...
                   const desclare_result_date = $('#desclare_result_date').val();
                    ...
                    $.ajax({
                        type: 'POST',
                        // dataType: "json",
                        url: "{{ route('admin.result-declare') }}",
                        data: formData2,
                        processData: false,
                        contentType: false,
                        headers: {
